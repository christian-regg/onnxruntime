...
#else
// note: we added an instruction (set priority of thread in pool)
...
static_assert(offsetof(OrtApi, ReleaseCANNProviderOptions) / sizeof(void *) == 225, "Size of version 13 API cannot change");
#endif // WITH_UE
